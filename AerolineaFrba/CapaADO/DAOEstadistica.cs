...
namespace AerolineaFrba.CapaADO
{
    class DAOEstadistica: SqlConnector
    {
        ...
        //Falta sp
         ...
         public static DataTable estadisticaClientesConMasPuntosAcumulados(decimal anio, int semestre)
         {

             return retrieveDataTable("sp_estadistico_clientes_mas_puntos_acumulados", anio, semestre);
